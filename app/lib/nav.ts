...
export const NAV_GROUPS: ReadonlyArray<NavGroup> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        blurb:
          "Shared registry that the keybinding hook and command palette subscribe to.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "SparklineBar",
        blurb:
          "Column sparkline for discrete per-period values; negatives turn destructive.",
      },
      {
        to: "/sparkline-winloss",
        label: "SparklineWinLoss",
        blurb:
          "Equal-height up/down ticks for binary outcomes — the pattern is the point.",
      },
      {
        to: "/sparkline-threshold",
        label: "SparklineThreshold",
        blurb:
          "Monitoring line with an acceptable band and a dashed limit; breaches are marked.",
      },
      {
        to: "/bullet-graph",
        label: "BulletGraph",
