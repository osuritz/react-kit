...
const latency = [118, 132, 121, 145, 160, 138, 152, 188, 240, 205, 170, 142, 128, 196, 210, 150];
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="border-border bg-card flex max-w-md flex-col gap-2 rounded-lg border p-4">
        <div className="flex items-baseline justify-between">
          ...
          <div className="text-muted-foreground font-mono text-xs">SLO 200ms · band 0–150</div>
        </div>
        <div className="flex items-baseline gap-2">
          <span className="text-2xl font-semibold tabular-nums">150 ms</span>
          <span className="text-xs font-semibold tabular-nums text-destructive">3 breaches</span>
        </div>
