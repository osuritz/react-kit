...
describe('SparklineThreshold', () => {
  it('renders the value line', () => {
    const { container } = render(<SparklineThreshold values={[1, 5, 2, 8, 4]} />);
  ...
  it('draws a dashed limit line when threshold is set', () => {
    const { container } = render(<SparklineThreshold values={[1, 2, 3]} threshold={2} />);
  ...
  it('draws a shaded band when band is set', () => {
    const { container } = render(<SparklineThreshold values={[1, 2, 3]} band={[1, 2]} />);
  ...
  it('marks points that breach the threshold as destructive', () => {
    const { container } = render(<SparklineThreshold values={[3, 7, 4, 9]} threshold={5} />);
  ...
  it('normalizes a reversed band instead of flagging every point', () => {
    ...
    const reversed = render(<SparklineThreshold values={[5, 25, 60]} band={[40, 10]} />);
    const ascending = render(<SparklineThreshold values={[5, 25, 60]} band={[10, 40]} />);
